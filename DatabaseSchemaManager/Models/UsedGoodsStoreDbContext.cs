...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=LMALANOWSKI\\SQLEXPRESS;Initial Catalog=UsedGoodsStoreDB;Integrated Security=SSPI;TrustServerCertificate=true;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AttributeProduct>(entity =>
        {
            ...
            entity.HasOne(d => d.Attribute1).WithMany(p => p.AttributeProducts)
        ...
        modelBuilder.Entity<AttributeValue>(entity =>
        {
            ...
            entity.HasOne(d => d.Attribute1).WithMany(p => p.AttributeValues)
                .HasForeignKey(d => d.AttributeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
